...
function calculateSalesTotals(item,original,stock,discount,sale){
    ...
    details["sale"] =  sale,
    details["total"] =  ((1 - discount) * original) * stock

    arr.push(details);
    console.log(arr);
}

calculateSalesTotals("Nintendo 64",199.99,2,0.65,69.9965);
calculateSalesTotals("Nintendo 64",199.99,2,0.65,69.9965);
calculateSalesTotals("Nintendo 64",199.99,2,0.65,69.9965);
calculateSalesTotals("Nintendo 64",199.99,2,0.65,69.9965);
calculateSalesTotals("Nintendo 64",199.99,2,0.65,69.9965);
