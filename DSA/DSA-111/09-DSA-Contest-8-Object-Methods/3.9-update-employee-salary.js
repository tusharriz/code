...
let employee = {
    ...
    getCountOfDepartment: function () {
        ...
        for (let i of arr) {
            ...
            if (departmentObj[i["department"]] == undefined) {
                departmentObj[i["department"]] = 1;
            }
        }
        // console.log(departmentObj); // { Tech: 1, Finance: 1, Ops: 1, Marketting: 1 }
        let count = 0;
        for (let key in departmentObj) {
            if (departmentObj[key] == 1) {
                count++;
            }
        }
        console.log(count); // 4
...
employee["updateEmployeeSalary"]("Tushar", 1000000000); // { name: 'Tushar', department: 'Tech', salary: 1000000000, level: 3 }
employee["updateEmployeeSalary"]("Lalu", 100000); // { name: 'Lalu', department: 'Finance', salary: 100000, level: 2 }
employee["updateEmployeeSalary"]("Tanya", 90000); // { name: 'Tanya', department: 'Marketting', salary: 90000, level: 2 }