...
employee["getHighestSalaryByDepartment"]("Tech"); // { name: 'Tushar', department: 'Tech', salary: 90000, level: 3 }
employee["getHighestSalaryByDepartment"]("Finance"); // { name: 'Prasad', department: 'Finance', salary: 85000, level: 3 }
employee["getHighestSalaryByDepartment"]("Ops"); // { name: 'Sneha', department: 'Ops', salary: 55000, level: 2 }
employee["getHighestSalaryByDepartment"]("Marketting"); // { name: 'Tanya', department: 'Marketting', salary: 57000, level: 2 }
