...
employee["getHighestSalaryByLevel"](1); // { name: 'Rahul', department: 'Tech', salary: 60000, level: 1 }
employee["getHighestSalaryByLevel"](2); // { name: 'Sohan', department: 'Tech', salary: 80000, level: 2 }
employee["getHighestSalaryByLevel"](3); // { name: 'Tushar', department: 'Tech', salary: 90000, level: 3 }