...
employee["getCountOfEmployeesInDepartment"]("Tech"); // { Tech: 3 }
employee["getCountOfEmployeesInDepartment"]("Finance"); // { Finance: 3 }
employee["getCountOfEmployeesInDepartment"]("Ops"); // { Ops: 2 }
employee["getCountOfEmployeesInDepartment"]("Marketting"); // { Marketting: 2 }
